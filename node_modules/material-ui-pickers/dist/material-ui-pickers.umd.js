(function (global, factory) {
    ...
    (global = global || self, factory(global['material-ui-pickers'] = {}, global.React, global.PropTypes, global['material-ui'].IconButton, global['material-ui'].InputAdornment, global['material-ui'].TextField, global.SvgIcon, global['material-ui'].Button, global['material-ui'].Dialog, global['material-ui'].DialogActions, global['material-ui'].DialogContent, global.styles, global['material-ui'].createStyles, global['material-ui'].withStyles, global['material-ui'].Toolbar, global['material-ui'].Typography, global.ReactDOM, global['material-ui'].Popover, global['material-ui'].Paper, global['material-ui'].withTheme, global['material-ui'].Tab, global['material-ui'].Tabs));
}(this, function (exports, React, PropTypes, IconButton, InputAdornment, TextField, SvgIcon, Button, Dialog, DialogActions, DialogContent, styles, createStyles, withStyles, Toolbar, Typography, reactDom, Popover, Paper, withTheme, Tab, Tabs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function (_super) {
      ...
      DateTextField.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (!utils.isEqual(utils.date(this.props.value), utils.date(prevProps.value)) || prevProps.format !== this.props.format || prevProps.maxDate !== this.props.maxDate || prevProps.minDate !== this.props.minDate || prevProps.emptyLabel !== this.props.emptyLabel || prevProps.utils !== this.props.utils) {
    ...
    */
    ...
    var ModalDialog = function (_a) {
      var children = _a.children,
          ...
          other = __rest(_a, ["children", "classes", "onKeyDownInner", "onAccept", "onDismiss", "onClear", "onSetToday", "okLabel", "cancelLabel", "clearLabel", "todayLabel", "clearable", "showTodayButton", "showTabs"]);
      ...
      return React.createElement(Dialog, __assign({
        ...
        onClose: onDismiss,
        classes: {
          paper: classnames(classes.dialogRoot, (_b = {}, _b[classes.dialogWithTabs] = showTabs, _b))
        }
        ...
        children: children,
        className: classnames(classes.dialog, (_c = {}, _c[classes.dialogWithTabs] = showTabs, _c))
      }), React.createElement(DialogActions, {
        classes: {
          root: clearable || showTodayButton ? classes.dialogActions : undefined,
          action: classnames(classes.dialogAction, (_d = {}, _d[classes.clearableDialogAction] = clearable, _d[classes.todayDialogAction] = !clearable && showTodayButton, _d))
        }
    ...
    var styles$1 = styles.createStyles({
      dialogRoot: {
    ...
    var ModalDialog$1 = styles.withStyles(styles$1, {
    ...
    function (_super) {
      ...
      ModalWrapper.prototype.render = function () {
        var _a = this.props,
            ...
            showTabs = _a.showTabs,
            other = __rest(_a, ["value", "format", "children", "onAccept", "onDismiss", "invalidLabel", "labelFunc", "okLabel", "cancelLabel", "clearLabel", "clearable", "todayLabel", "showTodayButton", "onOpen", "onClose", "onSetToday", "isAccepted", "DialogProps", "showTabs"]);
    ...
    var PickerToolbar$1 = withStyles(styles$2, {
    ...
    var SlideTransition$1 = withStyles(styles$4, {
    ...
    var CalendarHeader$1 = withStyles(styles$5, {
      withTheme: true,
    ...
    var Calendar$1 = withStyles(styles$7, {
    ...
    var Year$1 = withStyles(styles$8, {
      name: 'MuiPickersYear'
    })(Year);
    ...
    var YearSelection$1 = withStyles(styles$9, {
    ...
    var DatetimePickerHeader = withStyles(styles$f, {
    ...
    var DateTimePickerModal = function (props) {
      var value = props.value,
          ...
          other = __rest(props, ["value", "format", "autoOk", "openTo", "minDate", "maxDate", "initialFocusedDate", "showTabs", "autoSubmit", "disablePast", "disableFuture", "leftArrowIcon", "rightArrowIcon", "dateRangeIcon", "timeIcon", "renderDay", "ampm", "shouldDisableDate", "animateYearScrolling", "forwardedRef", "allowKeyboardControl"]); // do not show tabs for small screens
